...
package com.steadybit.discovery.spring;

import com.steadybit.discovery.spring.handlers.*;
import com.steadybit.discovery.spring.handlers.common.ApplicationContextScanner;
import com.steadybit.discovery.spring.handlers.httpclient.HttpClientRequestScanner;
 ...
 */
public class DiscoverySpringAgentPlugin implements AgentPlugin, CommandHandler {
    ...
    public DiscoverySpringAgentPlugin(Instrumentation instrumentation) {
