...
import com.steadybit.attacks.spring.advice.RestTemplateHttpStatusAdvice;
import com.steadybit.attacks.spring.advice.WebClientHttpStatusAdvice;
...
public class SpringHttpClientStatusInstrumentation extends ClassTransformationPlugin {
    ...
    protected AgentBuilder doInstall(AgentBuilder agentBuilder) {
        return agentBuilder //
                ...
                .transform(new ClassInjectionTransformer(this.getClass().getClassLoader(), "com.steadybit.attacks.spring.advice.InjectedClientHttpResponse"))
                ...
                .transform(new ClassInjectionTransformer(this.getClass().getClassLoader(),
                        "com.steadybit.attacks.spring.advice.InjectedReactiveClientHttpResponse"))
                .transform(new AgentBuilder.Transformer.ForAdvice(Advice.withCustomMapping() //
                        .bind(Registration.class, this.getRegistration())) //
