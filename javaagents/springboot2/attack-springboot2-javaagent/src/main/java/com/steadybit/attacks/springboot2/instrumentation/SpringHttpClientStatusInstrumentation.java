...
package com.steadybit.attacks.springboot2.instrumentation;

import com.steadybit.attacks.springboot2.advice.RestTemplateHttpStatusAdvice;
import com.steadybit.attacks.springboot2.advice.WebClientHttpStatusAdvice;
...
public class SpringHttpClientStatusInstrumentation extends ClassTransformationPlugin {
    ...
    protected AgentBuilder doInstall(AgentBuilder agentBuilder) {
        return agentBuilder //
                ...
                .transform(new ClassInjectionTransformer(this.getClass().getClassLoader(), "com.steadybit.attacks.springboot2.advice.InjectedClientHttpResponse"))
                ...
                .transform(new ClassInjectionTransformer(this.getClass().getClassLoader(),
                        "com.steadybit.attacks.springboot2.advice.InjectedReactiveClientHttpResponse"))
                .transform(new AgentBuilder.Transformer.ForAdvice(Advice.withCustomMapping() //
                        .bind(Registration.class, this.getRegistration())) //
