...
func NewJdbcTemplateException() action_kit_sdk.Action[JavaagentActionState] {
...
func jdbcTemplateExceptionConfigProvider(request action_kit_api.PrepareActionRequestBody) (any, error) {
